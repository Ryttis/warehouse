...
<div class="tocify-wrapper">
    ...
    <ul id="toc">
            ...
            <li>Last updated: April 14 2021</li>
        </ul>
</div>
...
<script>
    var baseUrl = "http://warehouse.test";
</script>
<script src="{{ asset("vendor/scribe/js/tryitout-2.5.3.js") }}"></script>
<blockquote>
<p>Base URL</p>
</blockquote>
<pre><code class="language-yaml">http://warehouse.test</code></pre><h1>Authenticating requests</h1>
